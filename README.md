...
-      Автозагрузка из файла при старте
   ...
   Как запустить:
-     Убедитесь, что установлен JDK (8 или новее).
-     Сохраните этот файл как NoteManager.java.
-     Откройте терминал в папке с файлом.
-     Скомпилируйте: javac NoteManager.java
-     Запустите:      java NoteManager
-     Следуйте инструкциям в консоли (выбор действия цифрами 1-5).
...
-      Auto-load from file on startup
   ...
   How to run:
-     Install JDK 8+.
-     Save this file as NoteManager.java.
-     Open terminal in the file's folder.
-     Compile: javac NoteManager.java
-     Run:      java NoteManager
-     Follow the console menu (enter numbers 1-5).
